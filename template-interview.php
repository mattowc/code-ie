...
$get_interviews = new WP_Query( $args );
get_header();?>
...
<?php if ($get_interviews->have_posts()) : while ($get_interviews->have_posts()) : $get_interviews->the_post(); ?>
...
<?php
	if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar(8) ) :  endif; 
?>
</div>
<?php 
wp_reset_postdata();
