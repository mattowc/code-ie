...
while( $get_posts->have_posts() )
{
    ...
    if( $featured == 'true' ) 
    {
        ...
        <?php if( $owc_shortcode != '' ): ?>
            <div style="display:inline-block; margin: 0 auto; margin-top: 10px;">
        ...
        <?php endif; ?>
        <div>
            <a href="http://173.254.48.32/~ieclothi/interview_category/i-love/" style="font-size: 14px; font-family: Georgia, Times New Roman, Times, serif; font-weight: normal; color: white; text-transform: uppercase;">View all interviews from IlovE</a>
        </div>
<?php 
    } //End if statement
} //End while statement
